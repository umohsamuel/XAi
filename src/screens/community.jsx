  ...
  return (
    <div className="snap-start mt-[10vh] min-h-[100vh] h-fit block tablet:flex justify-between mx-auto w-[80%] max-w-[100vw] lmax-w-[1043px]">
      ...
      >
        ...
        <p className="text-[#D1D1D2] text-center tablet:text-left text-xl tablet:text-[21.33px] tracking-[-0.16px] leading-[23.2px] tablet:leading-[34px] font-extralight">
        ...
        <h1 className=" font-semibold text-sm tablet:text-[20.33px] tracking-[-0.36px] leading-[27.4px] flex gap-4">
          Community
          <svg
            width="13"
            height="13"
