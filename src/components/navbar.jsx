...
function Navbar() {
  ...
  return (
    <nav className="z-[99999] absolute flex justify-between items-center w-[80%] tablet:w-[90%] mt-[3.5%] h-12 tablet:h-14 border-[0.5px] border-[#807DA9] rounded-xl px-[1rem] tablet:pr-14 tablet:pl-9 left-[50%] translate-x-[-50%] backdrop-blur-[2px] top-[0.5%] tablet:top-0">
