...
function FatExCard() {
  return (
    <motion.div
      ...
      whileInView="visible"
    >
      <div className="flex flex-col justify-between tablet:max-w-[677.34px] tablet:w-[600px]  max-w-[323px] h-[358px]  py-[41.31px] px-[32.34px] rounded-[20px] border-x border-y bg-opacity-[0.13] bg-gradient-to-tr from-transparent via-[#3B3B3B] to-transparent from-[20%] via-[100%] to-[100%] ">
